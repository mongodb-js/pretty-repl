...
Interface.prototype.original_writeToOutput = Interface.prototype._writeToOutput;
Interface.prototype.original_insertString = Interface.prototype._insertString;
...
Interface.prototype._writeToOutput = function (stringToWrite) {
  ...
  if (!this.__pretty) {
    return this.original_writeToOutput(stringToWrite);
  }
  if (stringToWrite === '\r\n' || stringToWrite === ' ') {
  ...
  if (startsWithPrompt) {
    ...
    this.original_writeToOutput(stringToWrite);
  }
};
...
Interface.prototype._insertString = function (c) {
  ...
  if (!this.__pretty) {
    return this.original_insertString(c);
  }
